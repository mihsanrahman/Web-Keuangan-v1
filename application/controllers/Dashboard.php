...
class Dashboard extends CI_Controller
{
	...
	public function index()
	{
		...
		//ACCOUNT RECEIVABLE
		$data['account_recieveble'] = $this->Statement_model->count_head_amount_by_id(5);		

		//CASH IN BANK
		$data['cash_in_bank'] = $this->Statement_model->count_head_amount_by_id(1);		

		//PAYABLES
		$data['payables'] = $this->Statement_model->count_head_amount_by_id(21);		
